...
class ActivityDataGrid extends DataGrid
{
    ...
    public function prepareColumns(): void
    {
        ...
        $this->addColumn([
            ...
            'closure' => fn ($row) => $sensitiveData->display('activities', 'title', $row->title),
        ]);
        ...
        $this->addColumn([
            ...
            'type' => 'string',
            'exportable' => $canViewSensitiveData,
            'closure' => fn ($row) => $sensitiveData->display('activities', 'comment', $row->comment),
        ]);
    ...
    {
        if (
            app(SensitiveDataService::class)->canView()
            && bouncer()->hasPermission('activities.edit')
        ) {
            $this->addAction([
                'index' => 'edit',
                'icon' => 'icon-edit',
