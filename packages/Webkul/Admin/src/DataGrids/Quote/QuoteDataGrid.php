...
class QuoteDataGrid extends DataGrid
{
    ...
    public function prepareColumns(): void
    {
        ...
        $canViewSensitiveData = $sensitiveData->canView();
        ...
        $this->addColumn([
            ...
            'type' => 'string',
            'sortable' => $canViewSensitiveData,
            'filterable' => $canViewSensitiveData,
            'exportable' => $canViewSensitiveData,
            'closure' => fn ($row) => $canViewSensitiveData ? core()->formatBasePrice($row->sub_total, 2) : config('sensitive-data.mask'),
        ]);
        ...
        $this->addColumn([
            ...
            'filterable' => $canViewSensitiveData,
            'exportable' => $canViewSensitiveData,
            'closure' => fn ($row) => $canViewSensitiveData ? core()->formatBasePrice($row->discount_amount, 2) : config('sensitive-data.mask'),
        ]);
        ...
        $this->addColumn([
            ...
            'sortable' => $canViewSensitiveData,
            'exportable' => $canViewSensitiveData,
            'closure' => fn ($row) => $canViewSensitiveData ? core()->formatBasePrice($row->tax_amount, 2) : config('sensitive-data.mask'),
        ]);
        ...
        $this->addColumn([
            ...
            'filterable' => false,
            'exportable' => $canViewSensitiveData,
            'closure' => fn ($row) => $canViewSensitiveData ? core()->formatBasePrice($row->adjustment_amount, 2) : config('sensitive-data.mask'),
        ]);
        ...
        $this->addColumn([
            ...
            'filterable' => $canViewSensitiveData,
            'exportable' => $canViewSensitiveData,
            'closure' => fn ($row) => $canViewSensitiveData ? core()->formatBasePrice($row->grand_total, 2) : config('sensitive-data.mask'),
        ]);
    ...
    {
        if (! app(SensitiveDataService::class)->canView()) {
            return;
        }
