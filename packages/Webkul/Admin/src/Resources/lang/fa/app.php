...
return [
    ...
    'components' => [
        ...
        'layouts' => [
            'powered-by' => [
                'description' => 'توسعه یافته توسط :topweb.',
            ],
            'header' => [
                'mega-search' => [
                    'title' => 'جستجوی بزرگ',
    ...
    'contacts' => [
        'persons' => [
            'index' => [
                ...
                'pending-review' => 'مخاطب برای بررسی ارسال شد.',
                'already-linked-warning' => 'مخاطب قبلاً به :name مرتبط شده است. ایجاد برای جلوگیری از تکرار مسدود شد.',
                ...
                'has_leads' => 'دارای سرنخ‌های مرتبط است.',
                'has_conversations' => 'دارای :count گفتگوی واتساپ مرتبط است.',
                'datagrid' => [
