...
return [
    ...
    'components' => [
        ...
        'layouts' => [
            'powered-by' => [
                'description' => 'Developed by :topweb.',
            ],
            'header' => [
                'mega-search' => [
                    'title' => 'Mega Search',
    ...
    'contacts' => [
        'persons' => [
            'index' => [
                ...
                'none-delete-warning' => 'None of the selected persons could be deleted because they are linked to leads or conversations.',
                'no-selection' => 'No persons were selected for deletion.',
                'delete-failed' => 'Failed to delete selected persons.',
                'has_leads' => 'Has linked leads.',
                'has_conversations' => 'Has :count linked WhatsApp conversation(s).',
                'datagrid' => [
