...
return [
    ...
    'components' => [
        ...
        'layouts' => [
            'powered-by' => [
                'description' => 'Desenvolvido por :topweb.',
            ],
            'header' => [
                'mega-search' => [
                    'title' => 'Busca rápida',
    ...
    'contacts' => [
        'persons' => [
            'index' => [
                ...
                'none-delete-warning' => 'Nenhuma das pessoas selecionadas pôde ser excluída porque estão vinculadas a leads ou conversas.',
                'no-selection' => 'Nenhuma pessoa foi selecionada para exclusão.',
                'delete-failed' => 'Falha ao excluir as pessoas selecionadas.',
                'has_leads' => 'Possui leads vinculados.',
                'has_conversations' => 'Possui :count conversa(s) de WhatsApp vinculada(s).',
                'datagrid' => [
