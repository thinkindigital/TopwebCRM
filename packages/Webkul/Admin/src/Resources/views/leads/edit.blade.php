@php($leadPayload = (new \Webkul\Admin\Http\Resources\LeadResource($lead))->resolve(request()))
...
<x-admin::layouts>
    ...
    >
        <div class="flex flex-col gap-4">
            ...
            <!-- Lead Edit Component -->
            <v-lead-edit :lead='@json($leadPayload)'>
            ...
            app.component('v-lead-edit', {
                ...
                data() {
                    return {
                        ...
                        lead:  @json($leadPayload),

                        person:  @json($leadPayload['person']),
