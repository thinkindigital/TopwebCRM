                ...
                <form @submit="handleSubmit($event, handleFormSubmit)">
                    ...
                    <x-admin::modal ref="stageUpdateModal">
                        ...
                        <x-slot:content>
                            ...
                            @if (app(\App\Services\SensitiveDataService::class)->canView())
                                <!-- Won Value -->
        ...
        app.component('v-lead-stages', {
            ...
            methods: {
                ...
                handleFormSubmit(event) {
                    ...
                    if (@json(app(\App\Services\SensitiveDataService::class)->canView()) && this.nextStage.code == 'won') {
                        params.lead_value = this.nextStage.lead_value;

                        params.closed_at = this.nextStage.closed_at;
                    } else if (@json(app(\App\Services\SensitiveDataService::class)->canView()) && this.nextStage.code == 'lost') {
