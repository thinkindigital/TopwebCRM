@php
    ...
    $personPayload = $lead->person
        ? (new \Webkul\Admin\Http\Resources\PersonResource($lead->person))->resolve(request())
        : null;
@endphp
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        @foreach ($personPayload['emails'] as $email)
                            <div class="flex gap-1">
                                ...
                                @else
                                    <span class="dark:text-white">{{ $email['value'] }}</span>
                                @endif
                        ...
                        @foreach ($personPayload['contact_numbers'] as $contactNumber)
                            <div class="flex gap-1">
                                ...
                                @else
                                    <span class="dark:text-white">{{ $contactNumber['value'] }}</span>
                                @endif
