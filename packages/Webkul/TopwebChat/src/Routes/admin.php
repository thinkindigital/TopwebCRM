...
use Webkul\TopwebChat\Http\Controllers\ConversationLeadController;
...
Route::prefix('topweb-chat')->group(function () {
    ...
    Route::put('conversations/{conversation}/lead', [ConversationLeadController::class, 'link'])->name('admin.topweb_chat.lead.link');
    Route::post('conversations/{conversation}/lead', [ConversationLeadController::class, 'create'])->name('admin.topweb_chat.lead.create');
